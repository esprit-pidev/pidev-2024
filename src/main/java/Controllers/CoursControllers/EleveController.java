     ...
     void naviguezVersEvaluation(ActionEvent event,int courid) {
        System.out.println(courid);
         try {
             ...
             EvaluationUserController evaluationUserController=loader.getController();
             evaluationUserController.setUserId(user);
             // Now that the FXML is loaded, get the controller
             CoursService cs=new CoursService();
                 Evaluation eval= cs.getEvaluationByIdCours(courid);
                 System.out.println(eval);
             evaluationUserController.setEvaluationId(eval.getId());
             evaluationUserController.initializeUI();

             // Set the evaluation ID from the first evaluation
